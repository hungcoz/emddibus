                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: IconButton(
                            ...
                            iconSize: 35,
                            onPressed: () {
                              if (!addressTo.contains("Điểm bắt đầu") &&
                                  !addressFrom.contains("Điểm kết thúc")) {
                                setState(() {
                                  String tmp = addressTo;
                                  addressTo = addressFrom;
                                  addressFrom = tmp;
                                });
                              } else if (!addressTo.contains("Điểm bắt đầu") &&
                                  addressFrom.contains("Điểm kết thúc")) {
                                setState(() {
                            ...
                            child: TextButton(
                              ...
                              onPressed: () async {
                                ...
                                List<Queue<Node>> queue =
                                    await a.findPath(start, target);
                                if (queue.isNotEmpty) {
                                  queue.forEach((element) {
                                    element.forEach((e) {
                                      print(
                                          "${e.currentNode.stopId} - ${e.routeId} - ${e.count}");
                                    });
                                    print("##########");
                                  });
                                } else
