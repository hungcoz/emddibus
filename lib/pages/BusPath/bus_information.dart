...
class BusInformation extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => BusInformationState(showBusPathState: showBusPathState, routeId: routeId);
    ...
    return NotificationListener<DraggableScrollableNotification>(
      onNotification: (DraggableScrollableNotification notification){
        showBusPathState.setState(() {
          ...
          showBusPathState.fabPosition = showBusPathState.dragScrollSheetExtent * showBusPathState.widgetHeight;
        });
        return;
      },
                        ...
                        Container(
                          child: ListTile(
                            ...
                            leading: GestureDetector(
                              onTap: (){
                               print( MediaQuery.of(context).size.height*0.5*0.85*0.85);
                              },
                              child: CircleAvatar(
                                backgroundColor: Colors.black26,
                                  child: Icon(_icon, color: Colors.blue,)
                              ),
                            ),
                            title: Text(
                              nameOfBus,
                              ...
                              onPressed: (){
                                ...
                                showBusPathState.setState(() {
                                  if (CHECK_DEPARTER_RETURN == 0){
                                    ...
                                    showBusPathState.markers = showBusPathState.markersReturn;
                                    //cập nhật path chiều về
                                    showBusPathState.listPoint = showBusPathState.listPointReturn;
                                    //cập nhật tên các điểm dừng chiều về
                                    showBusPathState.listStopPoint = showBusPathState.listStopPointReturn;
                                    // di chuyển camera đến điểm đầu của chiều về
                                    showBusPathState.mapController.move(
                                        showBusPathState.listPoint[showBusPathState.listPoint.length-1],
                                        16
                                    );
                                  }
                                  else {
                                    ...
                                    showBusPathState.markers = showBusPathState.markersDeparter;
                                    //cập nhật path chiều đi
                                    showBusPathState.listPoint = showBusPathState.listPointDeparter;
                                    //cập nhật tên các điểm dừng chiều đi
                                    showBusPathState.listStopPoint = showBusPathState.listStopPointDeparter;
                                    // di chuyển camera đến điểm đầu của chiều đi
                                    showBusPathState.mapController.move(showBusPathState.listPoint[0], 16);
                                  }
                                });
                              },
                                  ...
                                  Container(
                                    ...
                                    child: TabBarView(
                                      children: [
                                        ...
                                        ListNameBusStop(showBusPathState: showBusPathState, busInformationState: this,),
                                        Container(
                                          color: Colors.green,
                                          child: ListView.builder(
                                              itemCount: 10,
